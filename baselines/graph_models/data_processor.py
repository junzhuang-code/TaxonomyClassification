...
input_path = data_path+"corpus"
output_path = data_path+"clean_corpus"
...
class CorpusProcess:
    def __init__(self, dataset, encoding=None):
        ...
        self.input_corpus_name = f"{input_path}/{dataset}.txt"
        self.output_corpus_name = f"{output_path}/{dataset}.txt"
    ...
    def clean_text(self):
        sp = StringProcess()
        word_lst = list()
        with open(self.input_corpus_name, mode="rb", encoding=self.encoding) as fin:
        ...
        doc_len_lst = list()
        with open(self.output_corpus_name, mode='w') as fout:
            with open(self.input_corpus_name, mode="rb", encoding=self.encoding) as fin:
